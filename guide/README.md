...
the reader through numerous examples.Recommended to read [Guide to Programming with Turtle Art.](https://github.com/sugarlabs/turtleblocksjs/blob/master/guide/README.md)
